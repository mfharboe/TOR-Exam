...
public class RSS_ReaderAllFeed {

    private static RSS_ReaderAllFeed m_instance;
    ...
    private RSS_ReaderAllFeed() throws MalformedURLException {
        url = new URL(URL_STRING);
        currentFeed = new ArrayList<>();

    }

    public static RSS_ReaderAllFeed getInstance() throws MalformedURLException {
        if (m_instance == null) {
            m_instance = new RSS_ReaderAllFeed();
        }
        return m_instance;
    }
